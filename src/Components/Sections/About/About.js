		...
		<section className="aboutPage">
			...
			<div className="about p-3">
				...
				<div className="bioData d-flex align-items-center">
					<div className="imageArea col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4 col-xxl-4 pe-2">
						<img
							src={image}
							alt="sakib hasan"
							className="img-fluid"
					...
					<div className="infoArea col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8 col-xxl-8 ps-2">
			...
			<div className="facts p-3">
				...
				<div className="factsArea row align-items-center">
